      ...
      <div class="col-lg-6" :class="{ 'text-right': isRTL }">
        <card type="chart">
          <template slot="header">
            ...
            <h5 class="card-category">Total Photographer</h5>
            <h3 class="card-title">
              <i class="fas fa-user"></i>{{ totalPhotographer }}
            </h3>
          </template>
          <!-- <div class="chart-area">
      ...
      <div class="col-lg-6" :class="{ 'text-right': isRTL }">
        <card type="chart">
          <template slot="header">
            ...
            <h3 class="card-title">
              <i class="fas fa-user"></i>{{totalCustomer}}
            </h3>
          </template>
          <!-- <div class="chart-area">
...
export default {
  ...
  created() {
    this.$store.dispatch("getPhotographer");
    this.$store.dispatch("getCustomer");
  },
  computed: {
    totalPhotographer() {
      return this.$store.getters["totalPhotographer"];
    },
    totalCustomer() {
      return this.$store.getters["totalCustomer"];
    },
    enableRTL() {
